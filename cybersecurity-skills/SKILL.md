...
description: "网络安全分析师技能库：754个结构化安全技能，让AI具备Senior Analyst级别的全栈安全分析能力。覆盖威胁狩猎、数字取证、事件响应、渗透测试、代码安全审计、威胁情报、恶意软件分析等26个安全领域。映射MITRE ATT&CK v19.1、NIST CSF 2.0、MITRE ATLAS v5.4、MITRE D3FEND v1.3、NIST AI RMF 1.0五大框架。当用户说'安全分析'、'威胁狩猎'、'威胁情报'、'渗透测试'、'事件响应'、'MITRE'、'代码审计'、'数字取证'、'恶意软件分析'、'红队'、'蓝队'、'SOC'、'漏洞分析'、'安全运营'、'网络攻防'、'入侵检测'时触发。渐进式加载设计，500-2000 tokens完整加载，避免上下文溢出。"
---
